...
def compute_num_contours(polygon, radius=1):
    ...
    while not test_polygon.is_empty:
        ...
        if isinstance(test_polygon, MultiPolygon):
...
def compute_chi(polygon, init_pos, radius=1, lin_penalty=1.0, ang_penalty=1.0):
    """
