...
def solve(problem_name, solver_loc, cost_matrix, cluster_array):
	...
	if is_simple:
		...
		os.system("cp "+problem_name+".gtsp "+'/solver_logs/')
		os.system("cp "+problem_name+".par "+'/solver_logs/')
		...
		os.system("mv "+problem_name+".gtsp "+cur_dir+"/solver_logs")
		os.system("mv "+"TMP/"+problem_name+".par "+cur_dir+"/solver_logs")


		# Move the resulting file to home folder
		os.system("mv "+problem_name+".tour "+cur_dir+'/solver_logs')
...
def read_tour(problem_name):
	...
	with open('./solver_logs/'+problem_name+".tour", 'r') as f:
		for i in range(6):
			f.readline()
